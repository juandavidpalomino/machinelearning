...
public class WekaLinearRegression {
    ...
    public static void main(String[] args) throws Exception {
        ...
        labels = ZData.loadLabels("/house_price_berlin_data.txt");
        featuresList = ZData.loadFeaturesList("/house_price_berlin_data.txt");
        ...
        Graph graph = Graph.create(ZData.getFirstColumn(featuresList), labels, "house prices", "Price(€) in 1000´s", "Size in m²");
